...
int main(int argc, char* args[])
{
    ...
    */
    ...
    int initial_x = rand() % 1000 + 100;
    int initial_y = rand() % 500 + 100;
    ...
    */
    ...
    /**
     * [DONE]TODO: Plot x, y, theta over time
    ...
    if (init(gWindow, gRenderer, SCREEN_WIDTH, SCREEN_HEIGHT) >= 0)
    {
        ...
        while (!quit)
        {
            ...
            while (SDL_PollEvent(&e) != 0)
            {
                ...
                {
                    SDL_GetMouseState(&next_pos.x, &next_pos.y);
                    goal_state << next_pos.x, next_pos.y, 0, 0, 0, 0;
                    quadrotor.SetGoal(goal_state);
                }
